NAME = minishell
SRCS = init.c init_utils.c signal.c environ.c environ_utils.c eval.c parse_cmd.c tokenize.c parse.c parse_utils.c create_new_struct.c copy_struct.c get_info.c here_document.c expand.c expand_dollar.c expand_quote.c expand_wildcard.c expand_dollar_utils.c expand_utils.c exec.c exec_simple.c exec_connection.c exec_exit.c exec_null.c exec_utils.c redirect.c builtin_utils.c echo.c cd.c pwd.c export.c unset.c env.c exit.c free.c minishell.c ft_strjoin.c ft_itoa.c ft_substr.c #test_parser.c  
